...
/// falso positivo misurato in RETRIEVAL_PRECISION con un tag `src`). Escluderli dal
...
/// eval/moat-benchmark/scaled/RETRIEVAL_PRECISION.md): un tag che coincide con un
...
mod tests {
    ...
    fn a_structural_path_tag_no_longer_floods() {
        ...
        // Era il falso positivo misurato in RETRIEVAL_PRECISION.
        let selected = vec![
