...
impl QueryEngine {
    ...
    async fn expand(
        ...
        // tagliare dal limite. La Fase 0 ha misurato questo: query
...
fn format_context(
    ...
    // sezione che localizza. MISURATO (Fase 1, 37 commit):
...
mod tests {
    ...
    async fn seed_outranks_alphabetically_earlier_expansion_nodes() {
        // Regressione della Fase 0: il SEME (match esatto del
